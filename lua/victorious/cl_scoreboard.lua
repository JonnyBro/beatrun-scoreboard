		...
		adminbutton.DoClick = function()
			...
			if !AdminButtons then
				...
				banbutton.DoClick = function()
					//RunConsoleCommand("ulx", "ban", v:Nick(), VictoriousScoreboardConfig.bantime, VictoriousScoreboardConfig.breason)
				...
				if IsValid(adminbutton.teleportbutton) then
					adminbutton.teleportbutton:Remove()
				end
...
hook.Add("ScoreboardShow", "VictoriousScoreShow", function()
	...
	net.Receive("GetLevels", function(len, _)
