...
VictoriousScoreboardConfig.DefaultAdminMod = "ulx" --this could be "ulx", "fadmin" or "serverguard". Ask Admiration to add more(or ask any lua dev to edit settings in the end of this file)
...
VictoriousScoreboardConfig.showngroups["mostjobless"] = { ShownName = "MOST JOBLESS", GroupColor = Color(255, 198, 66) }
...
// KICK REASON
VictoriousScoreboardConfig.kreason = "Vous avez été exclu(e) !"

// BAN REASON
VictoriousScoreboardConfig.breason = "Vous avez été banni(e) pour %s minutes!"
...
VictoriousScoreboardConfig.KickText = "Exclure"

VictoriousScoreboardConfig.GotoText = "Aller"

VictoriousScoreboardConfig.TeleportText = "TP"

VictoriousScoreboardConfig.ReturnText = "Return"

VictoriousScoreboardConfig.JailText = "Prison"

VictoriousScoreboardConfig.BanText = "Ban"

VictoriousScoreboardConfig.CopySteamIDText = "Copier le SteamID de %s (%s)"
...
VictoriousScoreboardConfig.Levels = "Lv."
...
VictoriousScoreboardConfig.AdminMod["ulx"].ban = function(ply, time, reason)
    RunConsoleCommand("ulx", "ban", ply:Nick(), time, reason)
end

VictoriousScoreboardConfig.AdminMod["ulx"].kick = function(ply, reason)
    RunConsoleCommand("ulx", "kick", ply:Nick(), reason)
end

VictoriousScoreboardConfig.AdminMod["ulx"].jail = function(ply)
    RunConsoleCommand("ulx", "jail", ply:Nick())
end

VictoriousScoreboardConfig.AdminMod["ulx"].Goto = function(ply)
    RunConsoleCommand("ulx", "goto", ply:Nick())
end

VictoriousScoreboardConfig.AdminMod["ulx"].Teleport = function(ply)
    RunConsoleCommand("ulx", "teleport", ply:Nick())
end

VictoriousScoreboardConfig.AdminMod["ulx"].Return = function(ply)
